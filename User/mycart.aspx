...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
 ...
 <asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
          <asp:Label ID="Label11" runat="server" BackColor="#6a4da6" ForeColor="White"  Font-Size="Large"  style="z-index: 1; left: -7px; top: -5px; position: absolute; height: 45px; width: 356px" Text="Label"></asp:Label>
            ...
            <asp:GridView ID="grdcart" runat="server" style="z-index: 1; left: 820px; top: 417px; position: absolute; height: 115px; width: 196px" BackColor="White" BorderColor="White" BorderStyle="Ridge" BorderWidth="2px" CellPadding="3" CellSpacing="1" GridLines="None" OnRowCommand="grdcart_RowCommand">
               <Columns>
